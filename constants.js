...
export const award_scheduler =           process.env.AWARD_SCHEDULER || '0 0 12 1 * ?'; // Every month on the 1st, at noon
export const nag_scheduler =             process.env.NAG_SCHEDULER || '0 0 12 * * ?'; // Every day at noon _ 12pm
